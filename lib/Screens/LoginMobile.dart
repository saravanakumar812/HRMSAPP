...
class LoginMobile extends StatefulWidget {
  @override
  LoginMobileScreen createState() => LoginMobileScreen();
}

class LoginMobileScreen extends State<LoginMobile> {
  ...
  String? isValidEmail(String email) {
    ...
    if (email.isEmpty) {
      validEmail = "* Please enter Mobile Number";
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        alignment: Alignment.centerLeft,
                        child: Text(
                          'An otp will be sent to given mobile number'.tr,
                          style: TextStyle(
                              fontSize: 16,
